...
#아래 설명
# [1]사용중,[https] 웹ssl,[www.google.co.kr] 도메인,[443] 포트 80과 443등 알려진 포트도 반드시 기입, [1] 1 분간격으로 점검, [/?gws_rd=ssl] 이라는 url경로임, [Google Inc]라는 문구가 페이지 내에 있으면 정상  
1:https:www.google.co.kr:443:1:/?gws_rd=ssl:Google Inc
:
로그 파일의 종류는 
